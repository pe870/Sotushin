...
void clsMain::AppMain()
{
	...
	for (Ei = 0; Ei < E_MAX; Ei++)
	{
		...
		else if (E_ATTACKZ[Ei] && BBoxCollision(Enemy->m_aEnemy[Ei],Player->m_pPlayer))
		{
			Knkback = 1.5;
