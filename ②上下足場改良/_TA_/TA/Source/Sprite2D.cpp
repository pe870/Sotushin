	...
	const SPRITE_STATE& ss)
{
	...
	if (FAILED(InitModel(ss.Width,ss.Height,ss.U,ss.V)))
	{	return E_FAIL;	}
...
HRESULT clsSprite2D::InitModel(float Width, float Height, float U, float V)
{
...
//テクスチャ作成.
HRESULT	clsSprite2D::CreateTexture(LPSTR fileName, ID3D11ShaderResourceView** pTexture)
{
